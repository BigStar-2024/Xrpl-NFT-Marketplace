...
export const connectToAServer = async function(xrpl_obj) {
    if (xrpl_obj.isConnected) return;
    // "wss://xls20-sandbox.rippletest.net:51233"
    // "http://xls20-sandbox.rippletest.net:51234"
    xrpl_obj.client = new xrpl.Client("wss://xls20-sandbox.rippletest.net:51233");
    try {
        await xrpl_obj.client.connect();
        console.log("Connected to Sandbox");
        xrpl_obj.isConnected = true;
    } catch(error) {
        console.log(error);
    }
